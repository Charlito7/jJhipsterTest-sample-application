...
@WithMockUser
@EmbeddedKafka
class JhipsterTestKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/jhipster-test-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/jhipster-test-kafka/consume")
